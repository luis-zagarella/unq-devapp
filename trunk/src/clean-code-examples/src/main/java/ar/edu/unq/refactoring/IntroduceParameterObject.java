...
public class IntroduceParameterObject {
	...
	static class RepositorioDeClientes_v1 {
		...
		public void agregar(long id, String doc, String cuit, String nombre, String apellido, String telefono,
				String mail, String direccion, String localidad, String piso, String provincia) {
			// Agrega un nuevo cliente a la DB
		}

		public void modificar(long id, String doc, String cuit, String nombre, String apellido, String telefono,
				String mail, String direccion, String localidad, String piso, String provincia) {
